...
export const FocusLandingHero: React.FC = () => {
  ...
  return (
    <section className="relative bg-brand-darkest text-white pt-14 sm:pt-20 pb-16 sm:pb-24 overflow-hidden border-b border-white/10">
      {/* Background Glow */}
      <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[650px] h-[450px] bg-brand-primary/25 rounded-full blur-[110px] pointer-events-none" />
