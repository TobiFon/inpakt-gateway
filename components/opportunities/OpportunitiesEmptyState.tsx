...
export const OpportunitiesEmptyState: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="w-16 h-16 rounded-3xl bg-brand-subtle text-brand-dark flex items-center justify-center mx-auto mb-6 shadow-sm">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
        ...
        >
          {t("shareOpportunityCta")}
        </Button>
        <Button
          href="/focus"
          variant="secondary"
          size="md"
          icon={<Sparkles className="w-4 h-4 text-gold-deep" />}
        >
          {t("viewFocusCta")}
        </Button>
      </div>
